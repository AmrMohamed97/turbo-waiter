...
ThemeData light = ThemeData(
  ...
  textTheme: TextTheme(
    ...
    displayLarge: TextStyle(
        fontWeight: FontWeight.w300, fontSize: 24.sp, color: Colors.black),
    displayMedium: TextStyle(
        fontWeight: FontWeight.w400, fontSize: 22.sp, color: Colors.black),
    ...
    bodySmall: TextStyle(
        fontWeight: FontWeight.w900, fontSize: 17.sp, color: Colors.black),
    titleMedium: TextStyle(
        fontSize: 15.0.sp, fontWeight: FontWeight.w500, color: Colors.black),
    bodyMedium: TextStyle(fontSize: 12.0.sp),
    bodyLarge: TextStyle(
        fontSize: 14.0.sp, fontWeight: FontWeight.w600, color: Colors.black),
