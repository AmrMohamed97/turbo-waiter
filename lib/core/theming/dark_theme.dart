...
ThemeData dark = ThemeData(
  ...
  textTheme: TextTheme(
    ...
    displayLarge: TextStyle(
        fontWeight: FontWeight.w300, fontSize: 24.sp, color: Colors.white),
    ...
    titleLarge: TextStyle(
        fontWeight: FontWeight.w800, fontSize: 16.sp, color: Colors.white),
    bodySmall: TextStyle(
        fontWeight: FontWeight.w900, fontSize: 17.sp, color: Colors.white),
    titleMedium: TextStyle(
        fontSize: 15.0.sp, fontWeight: FontWeight.w500, color: Colors.white),
